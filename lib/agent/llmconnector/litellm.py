...
"""
Gestion communication modèle LLM avec LiteLLM
"""
class LiteLLM:
    def __init__(self):
        self._model    = Config.get(key="LITELLM_MODEL", type="env")
        self._api_base = Config.get(key="LITELLM_API_BASE", type="env")
        self._api_key  = Config.get(key="LITELLM_API_KEY", type="env")
