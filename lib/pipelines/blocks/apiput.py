...
#Bloc ApiPut : appelle une API REST en HTTP PUT. Les paramètres d'appel proviennent de la config du bloc.
#
...
#  - body           (dict|list|str,  défaut None) : corps de la requête (représentation complète de la ressource) ;
